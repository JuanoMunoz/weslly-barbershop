  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-secondary">
        <h3 class="modal-title text-uppercase" id="exampleModalLabel">PRODUCTO</h3>
        <h3 class="modal-title text-uppercase text-primary" style="margin-left: 5px;" id="exampleModalLabel"> <?php echo $servicio["nombre"]  ?> </h3>
